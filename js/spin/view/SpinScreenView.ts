...
export default class SpinScreenView extends QuantumMeasurementScreenView {
  ...
  public constructor( model: SpinModel, tandem: Tandem ) {
    ...
    this.addChild( new SpinStatePreparationArea( model.blochSphere, this.layoutBounds, this.mockupOpacityProperty!, tandem.createTandem( 'spinStatePreparationArea' ) ) );
  }
